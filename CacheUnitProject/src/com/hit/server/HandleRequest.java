...
public class HandleRequest<T> implements Runnable {
	...
	@Override
	public void run() { //recived Json request
		Type ref;
		T req = null;
		String json;
		...
		try {
			...
			if(req.equals("stat")) {	//if the client want the statistic
				...
				case DELETE : controller.delete(request.getBody());	//Delete data
				write.writeUTF("Deleted successfully"); break;
				case ADD 	: controller.update(request.getBody());	//Add Data
				write.writeUTF("Updated successfully"); break;
				case GET 	: 
